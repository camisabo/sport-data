...
public class competencia {
    ...
    public ListaEnlazada<deportista> deportistas;
    

    public competencia(Pila_ListaEnlazada<String> IDs_deportistas, ListaEnlazada<deportista> lista_deportistas) {
        inscribirDeportistas(IDs_deportistas, lista_deportistas);
    }

    public void inscribirDeportistas(Pila_ListaEnlazada<String> IDs, ListaEnlazada<deportista> lista) {
        ...
        while (!IDs.empty()) {
            ...
            if(lista.buscar(dep_inscribir)) {
                ...
                if(this.deportistas == null) {
                    this.deportistas = new ListaEnlazada<deportista>(dep_found);
                } else {
