...
public class App {
    ...
    public static void main(String[] args) throws IOException{
        ...
        ListaEnlazada<String> competencias = new ListaEnlazada<String>();
        ...
        while(programa){
            ...
            boolean ya = true;
            while(ya){
                if(sc_eleccion.hasNextInt()){
                    eleccion=sc_eleccion.nextInt();
                    ya=false;
                }else{
                    sc_eleccion.nextLine();
                }
            }
            ...
            switch (eleccion) {
                ...
                case 6:  //Administrar competencia
                    System.out.println("Inserte el nombre de la competencia:");
                    Scanner sc_5 = new Scanner(System.in);
                    String nombreCompetencia  = sc_5.nextLine();
                    ...
                    competencia1 = new competencia(nombreCompetencia, lista_deportistas, IDs);
                    ...
                    switch (elec_Comp) {
                        case 1:
                            ...
                            for (int i = 0; i < num_deportistas_inscribir; i++) {
                                String id = sc_Comp.nextLine(); 
                                competencia1.añadirDeportista(id);
                            }
                            ...
                            String competencia_txt = Actualizar_txt(competencia1.deportistasInscritos);
                            myWriter3.write(competencia_txt);
                            myWriter3.close();
                            */
                            break;
                        case 2:
                            competencia1.cerrarCompetencia();
                            competencia1.añadirResultado();
                            programa=false;
                            break;
                        default:
                            break;
                ...
                case 7: //mostrar resultados
                    competencia1.mostrarResultados();
                    break;
                case 8:
                    programa=false;
                    break;
